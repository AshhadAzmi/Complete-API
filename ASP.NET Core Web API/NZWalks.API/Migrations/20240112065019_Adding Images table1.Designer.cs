...
namespace NZWalks.API.Migrations
{
    ...
    [Migration("20240112065019_Adding Images table1")]
    partial class AddingImagestable1
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("NZWalks.API.Models.Domains.Difficulty", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("a576f91a-9589-485d-b6a1-54add16c2d36"),
                            Name = "Easy"
                        },
                        new
                        {
                            Id = new Guid("862e51b5-7f90-4729-b351-1de62b30a1b8"),
                            Name = "Medium"
                        },
                        new
                        {
                            Id = new Guid("274f3848-4b70-41af-9571-79dc163f9207"),
                            Name = "Hard"
                        });
                });
            ...
            modelBuilder.Entity("NZWalks.API.Models.Domains.Region", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("820d2b4f-5b43-4fb2-a06f-d45070815f97"),
                            Code = "AKL",
                            Name = "Auckland",
